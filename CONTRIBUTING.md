...
The ccc project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Ceiling-Catz/CCC/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ccc project, and is not to be
confused with overall ccc Network Protocol consensus changes.

Whether a pull request is merged into ccc rests with the project merge
...
Patches that change ccc consensus rules are considerably more involved than
...
Where a patchset proposes to change the ccc consensus, it must have been
...
The project leader is the release manager for each ccc release.
