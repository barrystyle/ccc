...
RESOURCES += src/qt/ccc.qrc src/qt/ccc_locale.qrc

TRANSLATIONS += src/qt/locale/ccc_bg.ts \
                src/qt/locale/ccc_de.ts \
                src/qt/locale/ccc_en.ts \
                src/qt/locale/ccc_es.ts \
                src/qt/locale/ccc_fi.ts \
                src/qt/locale/ccc_fr.ts \
                src/qt/locale/ccc_it.ts \
                src/qt/locale/ccc_ja.ts \
                src/qt/locale/ccc_pl.ts \
                src/qt/locale/ccc_pt.ts \
                src/qt/locale/ccc_ru.ts \
                src/qt/locale/ccc_sk.ts \
                src/qt/locale/ccc_sv.ts \
                src/qt/locale/ccc_vi.ts \
                src/qt/locale/ccc_zh_CN.ts \
                src/qt/locale/ccc_zh_TW.ts
