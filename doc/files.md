...
ccc.conf           | contains configuration settings for cccd or ccc-qt
cccd.pid           | stores the process id of cccd while running
...
debug.log           | contains debug information and general logging generated by cccd or ccc-qt
