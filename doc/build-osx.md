...
1. Clone the ccc source code:

        git clone https://github.com/Ceiling-Catz/CCC
        cd ccc
...
ccc is now available at `./src/cccd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/ccc"

    touch "/Users/${USER}/Library/Application Support/ccc/ccc.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/ccc/ccc.conf"

The first time you run cccd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/ccc/debug.log

Other commands:
-------

    ./src/cccd -daemon # Starts the ccc daemon.
    ./src/ccc-cli --help # Outputs a list of command-line options.
    ./src/ccc-cli help # Outputs a list of RPC commands when the daemon is running.
