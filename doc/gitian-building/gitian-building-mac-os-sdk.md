...
The script [extract-osx-sdk.sh](https://github.com/Ceiling-Catz/CCC/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
ccc/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/Ceiling-Catz/CCC/blob/master/doc/README_osx.md) for troubleshooting tips.
