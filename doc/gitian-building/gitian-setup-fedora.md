...
The build script we'll be using is contained in the ccc github repository ([contrib/gitian-build.py](https://github.com/Ceiling-Catz/CCC/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the ccc repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Ceiling-Catz/CCC/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, ccc-detached-sigs, and ccc GitHub repos.
