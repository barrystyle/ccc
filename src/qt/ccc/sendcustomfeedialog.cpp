...
#include "qt/ccc/sendcustomfeedialog.h"
#include "qt/ccc/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(cccGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &cccGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
