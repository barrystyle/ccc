...
#ifndef ccc_CORE_NEW_GUI_cccGUI_H
#define ccc_CORE_NEW_GUI_cccGUI_H
...
#include "qt/ccc/navmenuwidget.h"
#include "qt/ccc/topbar.h"
#include "qt/ccc/dashboardwidget.h"
#include "qt/ccc/send.h"
#include "qt/ccc/receivewidget.h"
#include "qt/ccc/addresseswidget.h"
#include "qt/ccc/coldstakingwidget.h"
#include "qt/ccc/masternodeswidget.h"
#include "qt/ccc/snackbar.h"
#include "qt/ccc/settings/settingswidget.h"
...
/**
  ccc GUI main class. This class represents the main window of the ccc UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class cccGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit cccGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~cccGUI();
...
#endif //ccc_CORE_NEW_GUI_cccGUI_H
