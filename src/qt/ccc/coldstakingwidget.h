...
#include "qt/ccc/furabstractlistitemdelegate.h"
#include "qt/ccc/txviewholder.h"
#include "qt/ccc/tooltipmenu.h"
#include "qt/ccc/sendmultirow.h"
#include "qt/ccc/coldstakingmodel.h"
#include "qt/ccc/contactsdropdown.h"
#include "qt/ccc/addressholder.h"
...
public:
    explicit ColdStakingWidget(cccGUI* parent);
    ~ColdStakingWidget();
