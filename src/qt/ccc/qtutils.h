...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, cccGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, cccGUI* gui, double posX = 3);
