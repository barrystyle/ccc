...
#include "qt/ccc/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(cccGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &cccGUI::openFAQ);
