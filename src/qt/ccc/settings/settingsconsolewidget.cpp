...
#include "qt/ccc/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ccc/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(cccGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the Ceiling Cat Coin RPC console.") + "<br>" +
