...
#include "qt/ccc/settings/settingsnetworkwidget.h"
#include "qt/ccc/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ccc/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(cccGUI* _window, QWidget *parent) :
