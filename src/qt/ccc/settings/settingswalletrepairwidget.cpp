...
#include "qt/ccc/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ccc/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(cccGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to cccGUI::handleRestart()
