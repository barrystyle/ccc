...
#include "qt/ccc/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/ccc/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(cccGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableCCC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableCCC,
    ...
    connect(ui->pushButton_UnspendableCCC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableCCC);});
    ...
    if (parent)
        connect(parent, &cccGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
