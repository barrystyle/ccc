...
#include "qt/ccc/topbar.h"
#include "qt/ccc/forms/ui_topbar.h"
#include "qt/ccc/lockunlock.h"
#include "qt/ccc/qtutils.h"
#include "qt/ccc/receivedialog.h"
#include "qt/ccc/loadingdialog.h"
...
TopBar::TopBar(cccGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopCCC}, "amount-small-topbar");
    setCssProperty({ui->labelAmountCCC}, "amount-topbar");
    setCssProperty({ui->labelPendingCCC, ui->labelImmatureCCC}, "amount-small-topbar");
    ...
    ui->pushButtonStack->setVisible(false); // CCC // hide
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // CCC Total
    QString totalCCC = GUIUtil::formatBalance(balance, nDisplayUnit);

    // CCC
    // Top
    ui->labelAmountTopCCC->setText(totalCCC);
    // Expanded
    ui->labelAmountCCC->setText(totalCCC);
    ui->labelPendingCCC->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureCCC->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
