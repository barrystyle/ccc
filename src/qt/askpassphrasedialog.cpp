...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            cccGUI* window = static_cast<cccGUI*>(parentWidget());
...
{
    cccGUI* gui = static_cast<cccGUI*>(parentWidget());
...
{
    hide();
    static_cast<cccGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Ceiling Cat Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your CCCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
