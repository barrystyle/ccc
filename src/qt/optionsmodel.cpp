...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizecccAmount") || reset)
        SoftSetArg("-anonymizecccamount", settings.value("nAnonymizecccAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in ccc.cpp during shotdown to also remove the window positions
