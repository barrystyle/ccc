...
/* ccc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Ceiling Cat Coin"
#define QAPP_ORG_DOMAIN "ceilingcatcoin.com"
#define QAPP_APP_NAME_DEFAULT "Ceiling Cat Coin-Qt"
#define QAPP_APP_NAME_TESTNET "Ceiling Cat Coin-Qt-testnet"
