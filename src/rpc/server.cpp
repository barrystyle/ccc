...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Ceiling Cat Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Ceiling Cat Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ccc features */
        /* Masternodes and budgets are not enabled in this version.
        {"ccc", "listmasternodes", &listmasternodes, true, true, false},
        {"ccc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ccc", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ccc", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ccc", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ccc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ccc", "masternodedebug", &masternodedebug, true, true, false},
        {"ccc", "startmasternode", &startmasternode, true, true, false},
        {"ccc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ccc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ccc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ccc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ccc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ccc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ccc", "preparebudget", &preparebudget, true, true, false},
        {"ccc", "submitbudget", &submitbudget, true, true, false},
        {"ccc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ccc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ccc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ccc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ccc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ccc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ccc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ccc", "checkbudgets", &checkbudgets, true, true, false},
        {"ccc", "mnsync", &mnsync, true, true, false},
        */
        {"ccc", "spork", &spork, true, true, false},

#ifdef ENABLE_WALLET
        /* Wallet */
        /* Staking not enabled in this version */
...
{
    return "> ccc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7980/\n";
}
